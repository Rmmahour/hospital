...
?>
    ...
    <!--Breadcrumb-->
        <section class="single_doctor breadcrumb_banner">
            <div class="container p_100">
                <div class="breadcrumb-container">
                    <div style="--bs-breadcrumb-divider: '-';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item" aria-current="page">Find a Doctor</li>
                            <li class="breadcrumb-item active" aria-current="page">Dr. Manoj Luthra</li>
...
MS, DNB, MCh (Cardiac Surgery)</p>
                        ...
                        <a href="#" class="bread_btn">
                            <span>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.6064 20.2075C16.6936 20.2075 15.9502 19.465 15.9502 18.5512C15.9502 17.6384 16.6936 16.895 17.6064 16.895C18.5193 16.895 19.2617 17.6375 19.2617 18.5512C19.2617 19.4649 18.5193 20.2075 17.6064 20.2075ZM17.6064 17.6056C17.0848 17.6056 16.6599 18.0305 16.6599 18.5521C16.6599 19.0738 17.0848 19.4987 17.6064 19.4987C18.128 19.4987 18.5521 19.0738 18.5521 18.5521C18.5521 18.0296 18.1271 17.6056 17.6064 17.6056Z" fill="white" stroke="white"/>
                                    <path d="M17.6065 19.0543C17.3297 19.0543 17.1035 18.829 17.1035 18.5513C17.1035 18.2745 17.3288 18.0483 17.6065 18.0483C17.8833 18.0483 18.1086 18.2737 18.1086 18.5513C18.1086 18.829 17.8833 19.0543 17.6065 19.0543ZM17.6065 18.3446C17.4921 18.3446 17.3989 18.4378 17.3989 18.5513C17.3989 18.6657 17.4921 18.758 17.6065 18.758C17.7209 18.758 17.8132 18.6649 17.8132 18.5513C17.8132 18.4378 17.72 18.3446 17.6065 18.3446Z" fill="white" stroke="white"/>
                                    <path d="M5.36145 21.4167C4.90637 21.4167 4.4779 21.2401 4.15499 20.919C3.83031 20.5961 3.65022 20.1668 3.64845 19.7081C3.64313 18.4848 4.96846 17.0992 5.75975 16.3816C6.11282 16.0614 6.64775 16.0587 7.00436 16.3754C7.80186 17.0851 9.14139 18.4592 9.1467 19.6833C9.14848 20.141 8.97194 20.5731 8.64993 20.8986C8.32702 21.2242 7.89767 21.4043 7.43904 21.407H7.43727C7.24211 21.407 7.08332 21.249 7.08243 21.0539C7.08154 20.8578 7.23945 20.6982 7.4355 20.6973C7.70429 20.6964 7.95623 20.5899 8.14518 20.3992C8.33412 20.2085 8.43793 19.9548 8.43704 19.6869C8.43438 19.0047 7.72205 17.965 6.53245 16.9068C6.4464 16.8305 6.32132 16.8313 6.23704 16.9085C5.05809 17.9775 4.35549 19.0234 4.35906 19.7064C4.35995 19.9752 4.46551 20.2271 4.65624 20.416C4.84519 20.6041 5.09624 20.707 5.36238 20.707H5.36859C5.56375 20.707 5.72254 20.8649 5.72342 21.0601C5.72431 21.2561 5.56641 21.4158 5.37036 21.4167L5.36145 21.4167Z" fill="white" stroke="white"/>
                                    <path d="M11.9994 12.3549C10.4221 12.3549 7.20898 9.26429 7.20898 5.67865C7.20898 3.09906 9.35753 1 11.9994 1C14.6412 1 16.7898 3.09888 16.7898 5.67865C16.7898 9.26429 13.5768 12.3549 11.9994 12.3549ZM11.9994 1.70968C9.74879 1.70968 7.91866 3.49007 7.91866 5.67865C7.91866 8.93523 10.8816 11.6452 11.9994 11.6452C13.1171 11.6452 16.0801 8.935 16.0801 5.67865C16.0801 3.49019 14.2491 1.70968 11.9994 1.70968Z" fill="white" stroke="white"/>
                                    <path d="M21.5488 23.0003H2.45129C1.65113 23.0003 1 22.3492 1 21.549V18.2064C1 15.231 3.41995 12.811 6.39537 12.811H7.93182C8.53326 12.811 9.10189 13.0736 9.49223 13.5305L11.9176 16.3719C11.9442 16.403 11.9771 16.4083 11.9957 16.4083C12.0054 16.4136 12.0471 16.4039 12.0746 16.371L14.4122 13.5537C14.8025 13.0826 15.3782 12.8121 15.9903 12.8121H17.6057C20.5802 12.8112 23.0002 15.232 23.0002 18.2065V21.5492C23.0002 22.3493 22.3489 23.0003 21.5488 23.0003ZM6.39528 13.5208C3.81205 13.5208 1.70959 15.6233 1.70959 18.2065V21.5492C1.70959 21.9581 2.04224 22.2908 2.4512 22.2908H21.5487C21.9577 22.2908 22.2903 21.9581 22.2903 21.5492V18.2065C22.2903 15.6233 20.1879 13.5208 17.6046 13.5208H15.9892C15.5882 13.5208 15.2121 13.6974 14.9566 14.0061L12.6191 16.8244C12.4656 17.0089 12.2394 17.1162 11.9999 17.118H11.9946C11.7568 17.118 11.5315 17.0142 11.3771 16.8332L8.95175 13.9927C8.69627 13.6938 8.32458 13.5226 7.93158 13.5226L6.39528 13.5208Z" fill="white" stroke="white"/>
                                    <path d="M6.04004 13.1655H6.74972V16.4948H6.04004V13.1655Z" fill="white" stroke="white"/>
                                    <path d="M17.252 13.1479H17.9616V17.2507H17.252V13.1479Z" fill="white" stroke="white"/>
                                </svg>
   ...
   <section class="trdd p_100">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="nav_inner">
                        <ul class="doc_tabs_list">
                            <li><a href="#main1" class="active">About Me</a></li>
                            <li><a href="#main2">Qualifications</a></li>
                            <li><a href="#main7">Experience</a></li>
                            <li><a href="#main3">OPD Timings</a></li>
                            <li><a href="#main4">Doctor Bites</a></li>
                            <li><a href="#main5">Doctor Blogs</a></li>
                            <li><a href="#main6">Book an Appointment</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9 col-md-8">
                    <div class="doc_single_data">
                        <div class="page-section doctors-tab listings" id="main1">
                            <div class="full-descp-1">
                                <p>Dr. Manoj Luthra is a highly experienced and renowned Cardiac surgeon in Noida with
                                    expertise in various adult and pediatric cardiac procedures.
                                    He has 30+ years of experience as a cardiac surgeon and performed the first heart
                                    transplantation surgery in the Indian Armed Forces.</p>
                                
                            </div>
                        </div>
                        
                        <div class="page-section doctors-tab listings" id="main2">
                        ...
                        <div class="page-section doctors-tab listings" id="main7">
                            <div class="full-descp">
                                <h3>Experience</h3>
                                <ul>
                       ...
                       <div class="page-section doctors-tab listings" id="main3">
    <div class="full-descp">
        <h2>OPD Schedule</h2>
        <div class="divTable">
            ...
            <h4>For Appointment Call: <a href="tel:+911204122222">+91 120 412 2222</a></h4>
                        ...
                        <div class="page-section doctors-tab listings" id="main4">
                            <div class="full-descp">
                                <h2>Doctor’s Bites</h2>
                                <div class="row">
                                    
                                    <div class="inner_story_box doctor-box col-6">
                                        <button class="play_button">
                                          <img src="assets/images/play-btn.png">
                                        </button>
                                        <iframe class="inner_story_video" width="100%" height="100%" src="https://www.youtube.com/embed/K4TOrB7at0Y?si=Lxok0zfngVbfKeFq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                    ...
                                    <!--<div class="doctor-box col-6">-->
                                    <!--    <img src="assets/images/dr-bites.png" alt="doctor">-->
                                    <!--    <p>Coronary Artery Bypass Grafting was Successfully</p>-->
                                    <!--</div>-->
                                    <!--<div class="doctor-box col-6">-->
                                    <!--    <img src="assets/images/dr-bites.png" alt="doctor">-->
                                    ...
                                    <!--<div class="doctor-box col-6">-->
                                    <!--    <img src="assets/images/dr-bites.png" alt="doctor">-->
                                    <!--    <p>Successfully Performed CABG & Mitral Valve Replacement at Jaypee Hospital,-->
                                    <!--        Noida</p>-->
                                    <!--</div>-->
                                    <!--<div class="doctor-box col-6">-->
                                    <!--    <img src="assets/images/dr-bites.png" alt="doctor">-->
                                    <!--    <p>At Jaypee, Iraqi Child treated successfully for Correction of Tetralogy of-->
                                    <!--        Fallot</p>-->
                                    <!--</div>-->
                                </div>
                        ...
                        <div class="page-section doctors-tab listings" id="main5">
                            <div class="full-descp">
              ...
              <div class="page-section doctors-tab listings" id="main6">
    <div class="full-descp">
        ...
        <!--                <option value="" disabled selected>Cardiac Surgery</option>-->
        <!--                <option value="bypass">Bypass Surgery</option>-->
        <!--                <option value="valve_replacement">Valve Replacement</option>-->
        <!--                <option value="angioplasty">Angioplasty</option>-->
        <!--                <option value="pacemaker_implant">Pacemaker Implant</option>-->
        ...
        <!--                <option value="" disabled selected>Dr. Manoj Luthra</option>-->
        <!--                <option value="manoj_luthra">Dr. Manoj Luthra</option>-->
        <!--            </select>-->
